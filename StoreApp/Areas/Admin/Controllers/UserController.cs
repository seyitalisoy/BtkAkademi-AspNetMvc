...
namespace StoreApp.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update([FromRoute(Name = "id")] string oldUserName, [FromForm] UserDtoForUpdate userDto)
        {
            if (ModelState.IsValid)
            {
                await _manager.AuthService.Update(oldUserName,userDto);
